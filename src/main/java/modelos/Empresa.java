...
public class Empresa {
    ...
    public Empresa(Empresa em){
        this.identificador = em.getIdentificador();
        this.codigoEmpresa = em.getCodigoEmpresa();
        this.empleados = em.getEmpleados();
        this.tipoEmpresa = em.getTipoEmpresa();
